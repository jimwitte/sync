...
3. create folders "app/views/cache" and 'app/views/template_c' and "app/views/configs". These are used by the smarty template engine.
4. chmod a+w for 'cache' and 'template_c' folders
